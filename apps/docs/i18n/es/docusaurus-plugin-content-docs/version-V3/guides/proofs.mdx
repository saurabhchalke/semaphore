...
Utilice la librería [`@saurabhchalke/proof`](https://github.com/semaphore-protocol/semaphore/tree/main/packages/proof) para generar una prueba off-chain.
...
```bash
npm install @saurabhchalke/proof@^3
```
...
```bash
yarn add @saurabhchalke/proof@^3
```
</TabItem>
<TabItem value="pnpm">

```bash
pnpm add @saurabhchalke/proof@^3
```
...
Utilice la librería [`@saurabhchalke/proof`](https://github.com/semaphore-protocol/semaphore/tree/main/packages/proof) para verificar una prueba Semaphore off-chain.
